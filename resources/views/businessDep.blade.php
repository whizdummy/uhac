 @extends('welcome')
 @section('mainBody')
 <div ng-controller = "businessDepCtrl as vm">
 <nav class="orange darken-2" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="#" class="brand-logo">Admin View</a>
      <ul class="right hide-on-med-and-down">
        ...
        <li class="active"><a href="#">Business Dependencies</a></li>
  ...
  <div class="section no-pad-bot" id="index-banner">
    <div class="container white z-depth-1" style="border-radius: 10px;">
      <div class="row z-depth-2">
        <h1 class="orange white-text darken-1" style="border-top-left: 10px !important; border-top-right: 10px !important; margin-bottom: 0;">Business Dependencies  <span class="thin"> Mainetenance</span></h1>
